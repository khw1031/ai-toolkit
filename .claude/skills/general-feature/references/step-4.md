...
```bash
# Agent가 작업을 완료하면 각 태스크별로 커밋
# (Agent가 자동으로 커밋하거나 수동으로 정리)
# Step 완료 시 최종 문서 커밋
...
**커밋 메시지 형식**:
- Agent 작업 단위: Agent가 자동 커밋하거나 `feat/<TASK_ID> - <태스크 설명>`
- Step 완료 시: `feat/<TASK_ID>-[AI]: Completed Step 4 implementation summary`
