---
description: >
  프롬프트 자산(Skills, Rules, Agents) 작성 시 적용되는 구조화 원칙.
  SKILL.md, RULE.md, AGENT.md 작성, 프롬프트 설계, 컨텍스트 최적화 시 활성화.
alwaysApply: true
---
...
| Rules | frontmatter | RULE.md 본문 | references/ |
...
- [Rules 작성 가이드](references/rules.md)
- [Agents 작성 가이드](references/agents.md)
- [Commands 작성 가이드](references/commands.md)
